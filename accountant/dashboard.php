...
<html>
    ...
    <head>
		...
		<title>HEMKO HOSPITAL | DASHBOARD</title>
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
					...
					
					{
						...
						start: new Date(2016, 12, 24),

						end:	new Date(2016, 12, 24)  
					...
					
					{
						...
						start: new Date(2016, 8, 22),

						end:	new Date(2016, 8, 22)  
					...
					
					{
						...
						start: new Date(2016, 8, 29),

						end:	new Date(2016, 8, 29)  
