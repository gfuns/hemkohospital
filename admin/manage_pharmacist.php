...
$msg = "Error! Unable To Delete Pharmacist";	
}	
}
...
$query = mysql_query("insert into staff(staffid, email, fullname, sex, phone, address, department, designation, specialty)values('$staffid','$email', '$fullname', '$sex', '$phone', '$address', 'Pharmacy', 'pharmacist', 'Pharmaceuticals')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Pharmacist Added Successfully";

$reclogin = mysql_query("insert into users(email, password, role)values('$email','pharmacist','pharmacist')");	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Pharmacist";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | MANAGE PHARMARCISTS</title>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div>Pharmacist's Name</div></th>
...
<?php 
	$sno = 1;
	$query = mysql_query("select * from staff where designation = 'pharmacist'");
	...
	?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="edit_pharmacist.php?id=<?php echo $view['staffid'];?>"
                            	...
                            	<a href="manage_pharmacist.php?id=<?php echo $view['staffid'];?>" onclick="return confirm('delete?')"
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="form-actions">
                            ...
                            <button name="submit" type="submit" class="btn btn-blue">Add Pharmacist</button>
