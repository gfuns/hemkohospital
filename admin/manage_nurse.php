...
$msg = "Error! Unable To Delete Nurse";	
}	
}
...
$dept = $_POST['dept'];	
$query = mysql_query("insert into staff(staffid, email, fullname, sex, phone, address, department, designation, specialty)values('$staffid','$email', '$fullname', '$sex', '$phone', '$address', '$dept', 'nurse', 'Nursing')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Nurse Added Successfully";

$reclogin = mysql_query("insert into users(email, password, role)values('$email','nurse','nurse')");	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Nurse";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | MANAGE NURSES</title>
...
<?php 
	$sno = 1;
	$query = mysql_query("select * from staff where designation = 'nurse'");
	...
	?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="edit_nurse.php?id=<?php echo $view['staffid'];?>"
                            	...
                            	<a href="manage_nurse.php?id=<?php echo $view['staffid'];?>" onclick="return confirm('delete?')"
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label">Nurse's Name</label>
                        ...
                        <div class="form-actions">
                            ...
                            <button name="submit" type="submit" class="btn btn-blue">Add Nurse</button>
