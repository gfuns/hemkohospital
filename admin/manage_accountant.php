...
$msg = "Error! Unable To Delete Accountant";	
}	
}
...
$query = mysql_query("insert into staff(staffid, email, fullname, sex, phone, address, department, designation, specialty)values('$staffid','$email', '$fullname', '$sex', '$phone', '$address', 'Finance', 'accountant', 'Accountancy')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Accountant Added Successfully";

$reclogin = mysql_query("insert into users(email, password, role)values('$email','accountant','accountant')");	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Accountant";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | MANAGE ACCOUNTANTS</title>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div>Accountant's Name</div></th>
...
<?php 
	$sno = 1;
	$query = mysql_query("select * from staff where designation = 'accountant'");
	...
	?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="edit_accountant.php?id=<?php echo $view['staffid'];?>"
                            	...
                            	<a href="manage_accountant.php?id=<?php echo $view['staffid'];?>" onclick="return confirm('delete?')"
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label">Accountant's Name</label>
                        ...
                        <div class="form-actions">
                            ...
                            <button name="submit" type="submit" class="btn btn-blue">Add Accountant</button>
