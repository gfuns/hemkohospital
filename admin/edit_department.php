...
$id=$_GET['id'];
if(!empty($id)){
$pickUp = mysql_fetch_array(mysql_query("select * from department where deptid = '$id'"));
}
if(array_key_exists("submit", $_POST)){
$name = $_POST['name'];	
$description = $_POST['description'];
$query = mysql_query("update department set name = '$name', description = '$description' where(deptid = '$id')");
$isClicked = true;
if($query==1){
...
$msg = "Error! Unable To Edit Department";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | EDIT DEPARTMENT</title>
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="name" value="<?php echo $pickUp['name'];?>"/>
                                ...
                                <div class="controls">
                                    ...
                                    <div class="box closable-chat-box">
                                        ...
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="description" id="ttt" rows="5"><?php echo $pickUp['description'];?></textarea>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Edit Department</button>
