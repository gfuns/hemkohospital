...
$msg = "Error! Unable To Delete Doctor";	
}	
}
...
$query = mysql_query("insert into staff(staffid, email, fullname, sex, phone, address, department, designation, specialty)values('$staffid','$email', '$fullname', '$sex', '$phone', '$address', '$dept', 'doctor', '$specialty')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Doctor Added Successfully";

$reclogin = mysql_query("insert into users(email, password, role)values('$email','doctor','doctor')");	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Doctor";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | MANAGE DOCTORS</title>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div>Doctor's Name</div></th>

                    		<th><div>Specialty</div></th>
	...
	?>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="edit_doctor.php?id=<?php echo $view['staffid'];?>"
                            	...
                            	<a href="manage_doctor.php?id=<?php echo $view['staffid'];?>" onclick="return confirm('delete?')"
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="padded">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="specialty"/>
                        ...
                        <div class="form-actions">
                            ...
                            <button name="submit" type="submit" class="btn btn-blue">Add Doctor</button>
