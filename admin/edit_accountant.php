...
$msg = "Accountant's Information Edited Successfully";
$logindel = mysql_query("delete from users where email = '$delemail'");
$reclogin = mysql_query("insert into users(email, password, role)values('$email','$pass','accountant')");	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Edit Accountant's Information";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | EDIT ACCOUNTANT</title>
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Edit Accountant</button>
