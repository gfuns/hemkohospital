...
$id=$_GET['id'];
if(!empty($id)){
$del = mysql_query("delete from blooddonor where donorid = '$id'");
$isClicked = true;
if($del==1){
$class = "alert alert-success";
$msg = "Donor's Information Deleted Successfully";	
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Delete Donor's Information";	
}
}
if(array_key_exists("submit", $_POST)){
$rowsql=mysql_query("select MAX(donorid) as max from `blooddonor`;");
...
$query = mysql_query("insert into blooddonor(donorid, fullname, bloodgroup, sex, dob, phone, email, address, lastdondate)values('$donorid', '$fullname', '$bloodgroup', '$sex', '$dob', '$phone', '$email', '$address', '$lastdondate')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Blood Donor Added Successfully";
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Blood Donor";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | MANAGE BLOOD DONOR</title>
...
<?php if($isClicked == true){ ?>
    ...
    <?php 
	$sno = 1;
	$query = mysql_query("select * from blooddonor");
	while($view = mysql_fetch_array($query)){
$day_temp = $view['lastdondate'];
...
?>
                        <tr>
							...
							<td><?php echo $view['bloodgroup'];?></td>

							<td><?php echo $newday." ".$newmonth.", ".$yr;?></td>

							<td align="center">

                            	<a href="edit_blood_donor.php?id=<?php echo $view['donorid'];?>"
                            	...
                            	<a href="manage_blood_donor.php?id=<?php echo $view['donorid'];?>" onclick="return confirm('delete?')"
	...
	<?php } ?>
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        <div class="padded">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="bloodgroup" class="uniform" style="width:100%;">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up" name="lastdondate"/>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Add Blood Donor</button>
    	...
    	<hr /><center>&copy; 2017 <a target="_blank" href="../index.html">HEMKO HOSPITAL, MAKURDI</a></center>
