...
$id=$_GET['id'];
if(!empty($id)){
$fetch = mysql_fetch_array(mysql_query("select * from blooddonor where(donorid = '$id')"));
}
...
$query = mysql_query("update blooddonor set fullname = '$fullname', phone = '$phone', email = '$email', address = '$address', lastdondate = '$lastdondate' where donorid = '$id'");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Donor's Information Edited Successfully";
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Edit Donor's Information";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | EDIT BLOOD DONOR</title>
                ...
                <div class="box-content">
					...
					<div class="padded">
                        <div class="control-group">
                                ...
                                <label class="control-label">Donor's Name</label>

                                <div class="controls">

                                    <input type="text" class="validate[required]" name="name" value="<?php echo $fetch['fullname'];?>"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="bloodgroup" value="<?php echo $fetch['bloodgroup'];?>" readonly="readonly"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="sex" value="<?php echo $fetch['sex'];?>" readonly="readonly"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="dob" value="<?php echo $fetch['dob'];?>" readonly="readonly"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="phone" value="<?php echo $fetch['phone'];?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="email" class="" name="email" value="<?php echo $fetch['email'];?>"/>
                                ...
                                <div class="controls">
                                    ...
                                    <div class="box closable-chat-box">
                                        ...
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="address" id="ttt" rows="5" placeholder="Enter Residential Address"><?php echo $fetch['address'];?></textarea>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label">Last Donation Date</label>

                                <div class="controls">

                                    <input type="text" class="datepicker fill-up" name="lastdondate" value="<?php echo $fetch['lastdondate'];?>"/>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Edit Blood Donor</button>
