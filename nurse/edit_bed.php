...
$id=$_GET['id'];
if(!empty($id)){
$fetch = mysql_fetch_array(mysql_query("select * from beds where(deptid = '$id')"));
}
if(array_key_exists("submit", $_POST)){
$qty = $_POST['qty'];
$quantity = $_POST['quantity'];
$newQty = $qty + $quantity;
$query = mysql_query("update beds set quantity = '$newQty' where deptid = '$id'");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Bed Information Edited Successfully";
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Edit Bed Information)";	
}	
}
...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | EDITED BED</title>
	...
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	...
            	<a href="#list" data-toggle="tab"><i class="icon-wrench"></i> 
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        <div class="padded">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                     ...
                                     <input type="text" class="" name="bedtype" value="<?php echo $fetch['bedtype'];?>" readonly="readonly"/>
							...
							<div class="control-group">
                                ...
                                <label class="control-label">Quantity Allocated</label>
							...
							<div class="control-group">
                                ...
                                <label class="control-label">Add/Remove Bed(s)</label>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Edit Bed</button>
