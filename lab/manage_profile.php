...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | LABORATORIST PROFILE</title>
                        ...
                        <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="" name="name" value="<?php echo $activeLaboratorist['fullname'];?>" readonly="readonly"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="" name="email" value="<?php echo $activeLaboratorist['email'];?>" readonly="readonly"/>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="" name="phone" value="<?php echo $activeLaboratorist['phone'];?>"/>
                                ...
                                <div class="controls">
                                    ...
                                    <div class="box closable-chat-box">
                                        ...
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="address" id="ttt" rows="5" placeholder="Enter Residential Address"><?php echo $activeLaboratorist['address'];?></textarea>
