...
$activeLaboratorist = mysql_fetch_array(mysql_query("select * from staff where(email = '$loggedInUser')"));
...
$rowsql=mysql_query("select MAX(id) as max from `laboratory`;");
...
$laboratorist = $activeLaboratorist['staffid'];
if (file_exists("uploads/".$_FILES["file"]["name"]))
{
$isClicked = true;
$class = "alert alert-danger";
$msg = "Error! A File With Thesame Name Already Exists! If This Is A Different Document, Please Rename It.";	
}else{
 move_uploaded_file($_FILES["file"]["tmp_name"], "uploads/" . $_FILES["file"]["name"]);
$fileurl = "uploads/" . $_FILES["file"]["name"];
$query = mysql_query("insert into laboratory(id, reporttype, doctype, description, recdate, laboratorist, caseid, fileurl)values('$labid', '$reporttype', '$doctype', '$description', '$recdate', '$laboratorist', '$id', '$fileurl')");
$isClicked = true;
if($query==1){	
$class = "alert alert-success";
$msg = "Lab Report Added Successfully";
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Add Lab Report";	
}	
}
}
?>
...
<html>
    ...
    <head>
		...
		<title>HEMKO HOSPITAL | ADD REPORT</title>
...
function ShowContactInfo(url,id,title, w) {
		var newWindow = window.open(url+""+id,"title","width="+w+",height=600,scrollbars=1");
	}
...
<?php if($isClicked == true){ ?>
	...
	<div class="box-content padded">
		...
		<div class="tab-content">
        	...
        	<?php 
			if(!empty($id)){
$query = mysql_fetch_array(mysql_query("select * from casehistory where(caseid = '$id')"));
}
			?>
...
?>
					...
					<div class="box">
                        ...
                        <div class="box-header"><span class="title">Laboratory Test Report(s)</span></div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-normal ">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><div>document type</div></td>

                                    <td><div>description</div></td>

                                    <td><div>date</div></td>

                                    <td><div>laboratorist,eo</div></td> 
									
									<td><div>view report</div></td>                                                                   
							...
							<?php
							$sno = 1;
							$query = mysql_query("select * from laboratory where caseid='$id'");
							while($view = mysql_fetch_array($query)){
							$idLab= $view['laboratorist'];
							$laboratoristName = mysql_fetch_array(mysql_query("select * from staff where staffid = '$idLab'"));
$day_temp = $view['recdate'];
$arr = explode("/", $day_temp, 3);
$day = $arr[1];
switch ($day) { 
case 01:  $newday = $day."st"; break; case 02:  $newday = $day."nd"; break; case 03:  $newday = $day."rd"; break; case 21:  $newday = $day."st"; break; 
...
default: $newmonth = ""; break;
							...
							?>
                                    ...
                                    <td><div><?php echo $sno++;?></div></th>

                                    <td><div><?php echo $view['reporttype'];?></div></td>

                                    <td><div><?php echo $view['doctype'];?></div></td>

                                    <td><div><?php echo $view['description'];?></div></td>

                                    <td><div><?php echo $newday." ".$newmonth.", ".$yr;?></div></td>

                                    <td><div><?php echo $laboratoristName['fullname'];?></div></td> 
									
									<td><div><a href="javascript:ShowContactInfo('http://localhost/abchospital/lab/','<?php echo $view['fileurl'];?>','<?php echo $view['reporttype'];?>','900')" rel="tooltip" data-placement="top" data-original-title="View Report" class="btn btn-blue">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header"><span class="title">Add Laboratory Test Report</span></div>

                        <div class="box-content">

                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal validatable">
                            <div class="padded">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" name="reporttype"  /> <span class="label label-blue">report type can be x-ray, blood-test etc.</span>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-blue">Add Test Report</button>
