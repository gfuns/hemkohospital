...
<html>
    ...
    <head>
<title>HEMKO HOSPITAL | DOCTOR DASHBOARD</title>
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
					...
					
					{
						...
						title: "appointment : RAKESH KUMAR",
					...
					
					{
						...
						start: new Date(2016, 11, 06),

						end:	new Date(2016, 11, 06)  
					...
					
					{
						...
						start: new Date(2016, 8, 26),

						end:	new Date(2016, 8, 26)  
