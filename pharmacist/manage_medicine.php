...
<html>
    ...
    <head>
		...
		<title>HEMKO HOSPITAL | MANAGE MEDICINE</title>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="edit_medicine.php?id=<?php echo $view['medid'];?>"
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="medname"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="category" class="uniform" style="width:100%;">
										...
										while($view = mysql_fetch_array($query)){
										?>                                    	
                                    		<option value="<?php echo $view['id'];?>"><?php echo $view['category'];?></option>
										<?php } ?>
                                    </select>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="manufcompany"/>
							...
							<div class="control-group">
                                ...
                                <label class="control-label">Quantity Added</label>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Add Medicine</button>
