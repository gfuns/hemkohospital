...
$id=$_GET['id'];
if(!empty($id)){
$query = mysql_fetch_array(mysql_query("select * from medcat where(id = '$id')"));
}
if(array_key_exists("submit", $_POST)){
$category = $_POST['category'];	
$description = $_POST['description'];
$write = mysql_query("update medcat set category = '$category', description = '$description' where id = '$id'");
$isClicked = true;
if($write==1){	
$class = "alert alert-success";
$msg = "Medicine Category Edited Successfully";
}else{
$class = "alert alert-danger";
$msg = "Error! Unable To Edit Medicine Category";	
}
}
?>
                ...
                <div class="box-content">
                    ...
                    <form action="" method="post" accept-charset="utf-8" class="form-horizontal validatable">
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="category" value="<?php echo $query['category']; ?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="description" value="<?php echo $query['description']; ?>"/>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="submit" class="btn btn-blue">Edit Medicine Category</button>
